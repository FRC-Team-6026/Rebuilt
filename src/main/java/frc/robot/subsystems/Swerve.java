...
public class Swerve extends SubsystemBase {
    ...
    public Swerve() {
        ...
        SmartDashboard.putData("Swerve Drive", new Sendable() {
            ...
            public void initSendable(SendableBuilder builder) {
                ...
                builder.addDoubleProperty("Front Right Angle", () -> mSwerveMods[1].getState().angle.getRadians(),
                        null);
    ...
    public void drive(Translation2d translation, double rotation, boolean fieldRelative, boolean isOpenLoop) {
        SwerveModuleState[] swerveModuleStates = Constants.Swerve.swerveKinematics.toSwerveModuleStates(
            fieldRelative
                ? ChassisSpeeds.fromFieldRelativeSpeeds(translation.getX(), translation.getY(), rotation, getAngle())
    ...
    public Command testInit() {
        // Check to make sure our swerve.setAngle() jitter protection doesnt cause
        // problems with this
    ...
    // SysID - 4 commands for the 4 SysID tests. Each one can be bound to a button,
    // and cancelled when the button is released.
    public Command SysIDQuasiF() {
        return sysIdRoutine.quasistatic(SysIdRoutine.Direction.kForward);
    }

    public Command SysIDQuasiR() {
        return sysIdRoutine.quasistatic(SysIdRoutine.Direction.kReverse);
    }

    public Command SysIDDynF() {
        return sysIdRoutine.dynamic(SysIdRoutine.Direction.kForward);
    }

    public Command SysIDDynR() {
