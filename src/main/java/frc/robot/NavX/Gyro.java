...
public interface Gyro extends AutoCloseable {
   ...
   *
   * &lt;p&gt;The angle is continuous, that is it will continue from  to  degrees. This allows
   * algorithms that wouldn't want to see a discontinuity in the gyro output as it sweeps past from
   *  to  on the second time around.
   *
  ...
  /**
   * Return the heading of the robot as a {@link edu.wpi.first.math.geometry.Rotationd}.
   *
   * &lt;p&gt;The angle is continuous, that is it will continue from  to  degrees. This allows
   * algorithms that wouldn't want to see a discontinuity in the gyro output as it sweeps past from
   *  to  on the second time around.
   ...
   * &lt;p&gt;This heading is based on integration of the returned rate from the gyro.
   *
   * @return the current heading of the robot as a {@link edu.wpi.first.math.geometry.Rotationd}.
   */
