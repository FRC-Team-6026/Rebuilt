...
public final class Constants {
    ...
    public final static class ConversionFactors {
        ...
        public static final double shooterConversionPositionFactor = 11.0/18.0 * 0.318;    // 11:18 gear reduction (possibly moving to 13:16), 4in diameter * pi conversion to circumference
